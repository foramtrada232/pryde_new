...
export default class Lab_booking_pathology extends React.Component {
    render() {
                        ...
                        <Row>
                            <Col xs lg="6" className="float-left">
                                <div className="page_title">
                                    <h5 className="font-weight-normal">Lab Booking [Pathologist]
                                        <Image
                                            src={heartbeat}
                                            width="50"
                                            height="20"
                ...
                <section className="lab_booking">
                    <Container>
                        <div className="section_title mt-3">
                            <h2 className="text-black">Lab [Pathologist]<Image src={heartbeat} alt="heart beat icon" height={20} width={50} /></h2>
                        </div>

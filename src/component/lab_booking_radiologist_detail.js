...
export default class Lab_booking_radiologist_detail extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <section className="child_vaccination emo_detail_tab">
                    <Container>
                        <div className="page_title">
                            <h1>Radiologist<Image src={heartbeat} alt="heart beat icon" /></h1>
                        </div>
                        ...
                        <div className="emotional_radio_btn">
                            <div className="row m-0">
                                <Col lg={1} md={2} sm={2} className="form-check radio_btn p-0">
                                    <input className="form-check-input" type="radio" name="audio" id="audio1" defaultValue="option1" defaultChecked />
                                    <label className="form-check-label text-center" for="audio1">Audio</label>
                                </Col>
                                <Col lg={1} md={2} sm={2} className="form-check radio_btn p-0">
                                    <input className="form-check-input" type="radio" name="audio" id="video1" defaultValue="option2" />

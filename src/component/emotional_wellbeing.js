        ...
        return (
            <div>
                        ...
                        <Row>
                            <Col lg={7}>
                                <div className="page_title">
                                    <h1>Emotional Wellbeing<Image src={heartbeat} alt="heart beat icon" height={20} width={50} /></h1>
                                </div>
                            </Col>
                            <Col lg={5}>
                ...
                <section className="specialities">
                    <Container>
                        <div className="section_title">
                            <h2>Specialities<Image src={heartbeat} alt="heart beat icon" height={20} width={50} /></h2>
                ...
                <section className="see_how_it_work">
                    <Container>
                        <div className="section_title">
                            <h2 className="text-black">See how it works<Image src={heartbeat} alt="heart beat icon" height={20} width={50} /></h2>
                        </div>

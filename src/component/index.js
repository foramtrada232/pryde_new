...
// Component
import { Image, Col, Row, Container, Tab, Nav, Accordion, Card } from 'react-bootstrap';
import heartbeat from './images/light_blue_heart_beat_icon.svg';
import heartbeat_blue from './images/dark_blue_heart_beat_icon.svg'
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="our_service_for_mobile">
                    <Container>
                        <div className="section_title">
                            <h2>Our Services
                                <Image
                        ...
                        <Accordion defaultActiveKey="0">
                            ...
                            <Card>
                                ...
                                <Accordion.Collapse eventKey="3">
                                    <Card.Body>
                                        <h5>Medicines & Medical Supplies</h5>
                                        <p>"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
                                    </Card.Body>
                                </Accordion.Collapse>
                            </Card>
